...
const { generateInvoice,generateBulkInvoice } = require("../controllers/invoice.controller");
...
// pdf generation route for invoice
orderRouter.get("/:orderId/invoice", protect, generateInvoice);
orderRouter.post("/invoices/bulk", protect, generateBulkInvoice);
