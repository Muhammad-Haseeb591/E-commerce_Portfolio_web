...
const Header = () => {
  ...
  // 🔑 Auth logic — yahan add kiya, Navbar se hata diya
  ...
  // Click-outside se dropdown close karne ke liye
  useEffect(() => {
  ...
  return (
    ...
    <div className='flex justify-between items-center w-full sx:h-[48px]'>
     ...
     <div className='ml-[15px] mt-[5px] ' style={{
          position: "absolute",
          left:"0",
          zIndex:"50"
...
<div className='flex justify-between '>
  {/* Location + Sign In */}
   ...
   {/* Cart */}
        ...
        {/* 🔑 user logo — ab conditional hai. Size (27x27) aur classes bilkul same rakhi hain */}
            ...
            <>
              ...
              {profileMenuOpen && (
                <div className="absolute right-0 top-[38px] w-[180px] bg-white border border-gray-200 rounded-[8px] shadow-md z-50 py-2">
                  ...
                  {/* 🔑 Order history — AccountActivity component ka orders tab */}
                  <Link
                    to="/account/orders"
                  ...
                  {/* 🔑 My reviews — AccountActivity component ka reviews tab */}
                  <Link
                    to="/account/reviews"
                    onClick={() => setProfileMenuOpen(false)}
                    className="flex items-center gap-2 px-4 py-2 text-[13px] text-black/70 hover:text-black hover:bg-gray-50"
                  ...
                  {/* 🔑 Favourite link — sirf profile dropdown ke andar, aur lg+ screens pe hidden */}
                  <Link
                    to="/favourite"
                    onClick={() => setProfileMenuOpen(false)}
